...
export default function Nav() {
  ...
  return (
    <nav id="nav">
      ...
      <div
        id="smallNav"
        class="z-0 absolute top-0 flex flex-col items-center w-16 h-full overflow-hidden text-gray-400 bg-gray-900 rounded"
      >
      ...
      <div
        id="fullNav"
        class="z-10 absolute top-0 flex flex-col items-center w-40 h-full overflow-hidden text-gray-400 bg-gray-900 rounded"
      >
        <a class="flex items-center w-full px-3 mt-3" href="#">
          <svg
            class="ml-1 w-8 h-8 fill-current"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20"
            fill="currentColor"
          >
